...
template_dict: Dict[str, str] = {'back': '../res/cart/back.PNG',
                                 'payment': '../res/cart/payment.PNG',
                                 'product_search': '../res/cart/produkte_finden.PNG',
                                 'rezepte': '../res/cart/rezepte.PNG',
                                 'warenkorb': '../res/cart/warenkorb.PNG'}
